          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [_vermelho, _laranja],
              ),
              shape: BoxShape.circle,
              boxShadow: [
                BoxShadow(
                  color: _vermelho.withValues(alpha: 0.4),
                  blurRadius: 20,
    ...
    return Container(
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [_cinzaEscuro, Color(0xFF1F1F1F)],
        ),
        boxShadow: [
          BoxShadow(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [Colors.white, Colors.blue[25] ?? Colors.white],
        ),
        borderRadius: BorderRadius.circular(16),
        border: Border.all(color: _vermelho.withValues(alpha: 0.15), width: 2),
        boxShadow: [
          BoxShadow(
                    ...
                    Container(
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                          ...
                          colors: _processandoJogada
                          ? [Colors.grey[400]!, Colors.grey[300]!]
                          : [Colors.orange.shade700, Colors.orange.shade600],
                        ),
                        borderRadius: BorderRadius.circular(10),
                        boxShadow: _processandoJogada
                        ? []
                        : [
                            BoxShadow(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [_vermelho, Color(0xFF8B2E1B)],
        ),
  ...
  Widget _buildMaoJogador(EstadoPartida estado) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(16),
        border: Border.all(color: _azul.withValues(alpha: 0.15), width: 2),
        boxShadow: [
          BoxShadow(
